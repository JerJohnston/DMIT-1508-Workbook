...
-- @@ERROR is a global variable that contains the error number generated by the last INSERT/DELETE/UPDATE statement.  
-- @@ERROR is not changed by doing a select statement.
-- @@ROWCOUNT is a global variable that contains the number of 
